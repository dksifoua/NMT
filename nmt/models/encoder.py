...
class EncoderLayerBiLSTM(nn.Module):
    ...
    def __init__(self, embedding_size, hidden_size, vocab_size, n_layers, dropout, recurrent_dropout):
        ...
        self.lstm = nn.LSTM(input_size=embedding_size, hidden_size=hidden_size, num_layers=n_layers, bidirectional=True,
    ...
    def load_embeddings(self, embeddings):
        ...
        """
        if embeddings.shape != (self.vocab_size, self.embedding_size):
    ...
    def forward(self, input_sequences, sequence_lengths):
        ...
        if input_sequences.shape[1] != sequence_lengths.shape[0]:
            raise ValueError('The batch_size of inputs doesn\'t match')
